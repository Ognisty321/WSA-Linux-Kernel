...
| --- | ---: | --- | --- | --- | --- | --- |
| `D:\WSA` upstream-sync candidate `2026-04-28` | `26200` | 5.15.104 | on | installed `/data/adb/ksud` SHA256 `3f94c8ffaa8e2d030a18f6fc72819dd34ef5c625be31d1c2dcadb672d6f4c833` exposes `kpm` | kernel/KPM/userspace pass | `D:\WSA\Tools\kernel` replaced with kernel `#37`, SHA256 `08112c906f8ef5655005e3589edbb9d5e088f48159e806054f9ebbd55c6814d1`; backup saved as `D:\WSA\Tools\kernel.backup.sync-20260428-145951`; `uname -a` reported `#37 SMP PREEMPT Tue Apr 28 14:26:48 CEST 2026`; ReSukiSU submodule `636c3315876d` merges upstream `74b9b48b`; sidecar manifest verification passed; `RUN_WSA=1 KSUD=/data/adb/ksud REMOTE_DIR=/data/local/tmp/kpm-test CONTROL_LOOPS=20 bash KernelSU/scripts/kpm-x86-preflight.sh` passed with native `syscall_wrap`, final `modules=0` and clean dmesg scan; `KSUD=/data/adb/ksud scripts/wsa-kpm-boot-smoke.sh LOOPS=3` passed. |
